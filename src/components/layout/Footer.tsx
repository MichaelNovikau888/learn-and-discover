        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center mb-6">
              <img src="/logo-fasol.png" alt="Фа Соль - школа вокала" className="h-14 w-auto brightness-0 invert" />
            </Link>
            <p className="text-muted-foreground max-w-md mb-6">
              Научим петь любого благодаря современной методике и опыту работы более 5 лет. 
              Раскройте свой голос вместе с нами!
            </p>
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full bg-[#4C75A3] flex items-center justify-center text-white hover:opacity-90 transition-opacity"
              >
                <VKIcon />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] flex items-center justify-center text-white hover:opacity-90 transition-opacity"
              >
                <InstagramIcon />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-muted-foreground">
                ...
                <span>г. Минск, ул. Кульман 9</span>
              </li>
            </ul>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display font-bold text-lg mb-6">Навигация</h4>
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/#mission" className="text-muted-foreground hover:text-background transition-colors">
                  Наша миссия
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/#events" className="text-muted-foreground hover:text-background transition-colors">
                  Мероприятия
                </Link>
              </li>
              <li>
                <Link to="/auth" className="text-muted-foreground hover:text-background transition-colors">
                  Записаться
                </Link>
              </li>
            </ul>
      ...
      <div className="border-t border-muted-foreground/20">
        <div className="container py-6">
          <div className="text-sm text-muted-foreground space-y-1">
            <p className="font-medium text-background">ООО "ШКОЛА ВОКАЛА ФА СОЛЬ"</p>
            <p>Адрес: БЕЛАРУСЬ, Г. МИНСК, ул. Кульман 9</p>
            <p>УНП: 193607762</p>
            <p>Карт-счет: BY47ALFA30122B37600010270000 в BYN в ЗАО «Альфа-Банк», БИК: ALFABY2X</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-muted-foreground/20">
        <div className="container py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} ООО "ШКОЛА ВОКАЛА ФА СОЛЬ". Все права защищены.
          </p>
          <div className="flex items-center gap-6 text-sm">
            <Link to="/privacy" className="text-muted-foreground hover:text-background transition-colors">
              Политика конфиденциальности
            </Link>
            <Link to="/offer" className="text-muted-foreground hover:text-background transition-colors">
              Условия оферты
            </Link>
          </div>
        </div>
